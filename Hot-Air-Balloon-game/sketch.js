...
//background image
bg = createSprite(400,400,1,1);
bg.addImage(bgImg);
bg.scale = 2


//creating top and bottom grounds
bottomGround = createSprite(200,890,800,20);
...
//creating balloon     
balloon = createSprite(windowWidth/7,windowHeight/2,20,50);
...
gameOver = createSprite(windowWidth/2-20,windowHeight/2-30);
restart = createSprite(windowWidth/2-20,windowHeight/2-1);
...
function spawnObstaclesTop() 
{
  if(World.frameCount % 60 === 0) {
    obstacleTop = createSprite(windowWidth/2,windowHeight/4-30,40,50);
...
obstacleTop.y = Math.round(random(windowHeight/1, windowHeight/33));
...
{
      if(World.frameCount % 60 === 0) {
        obstacleBottom = createSprite(windowWidth/2,windowHeight/4-30,40,50);
        obstacleBottom.y = Math.round(random(windowHeight/1, windowHeight/33));
